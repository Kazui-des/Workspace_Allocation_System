...
def seed_workspaces():
    ...
    default_workspaces = [
        {"name": "Workspace 1", "capacity": 4, "amenities": "Wi-Fi, Whiteboard, Projector"},
        {"name": "Workspace 2", "capacity": 6, "amenities": "Wi-Fi, Monitor, AC"},
        {"name": "Workspace 3", "capacity": 10, "amenities": "Wi-Fi, Conference Setup"},
    ]
